    ...
    livePage.prototype.scanPage = function() {
        ...
        if (this.options.monitor_js == true) {
            ...
            for (var key = 0; key < elements.length; key++) {
                ...
                if(elements[key].src.indexOf("liveBgPage.js") > -1){ 
                   continue;
                }
    ...
    LiveResource.prototype.refresh = function() {
        ...
        if (this.type == 'css') {
            ...
            try {
                ...
                (function () {
                  /*  sogouExplorer.management.getAll(function(b) {
                        var d = {};
                        for (var c = 0; c < b.length; c++) {
                            d = b[c];
                            if ((d.installType == "development") && (d.enabled == true) && (d.name != "liveReload")) {
                                (function(a) {
                                    sogouExplorer.management.setEnabled(d.id, false, function() {
                                        sogouExplorer.management.setEnabled(a, true)
                                    })
                                })(d.id)
                            }
                        }
